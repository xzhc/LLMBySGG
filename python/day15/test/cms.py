...
# Ensure the import path matches your local directory structure
...
class CMS:
    ...
    def set_customer_age(self):
        """Input customer age"""
        customer_age = input("Please enter customer age:")
    ...
    def set_customer_name(self):
        """Input customer name with 3 attempts"""
        customer_name = "None"
        for i in range(3):
            if i < 2:
    ...
    def set_customer_id(self):
        """Input customer ID with 3 attempts"""
        customer_id = "None"
        for i in range(3):
            if i < 2:
                ...
                if Customer.check_id(customer_id):
                    ...
                    print("ID must be numeric only. Please try again.")
            else: 
    ...
    def add_customer(self):
        ...
        # Add new customer to the ID dictionary
        self.customer_id_dict[customer_id] = customer

        # Handle the Name dictionary (k: name v: {k: c_id, v: customer})
    ...
    def start(self):
        """Start the system and enter the menu loop"""
        try:
            while True:
                self.display_menu()
            ...
            print(f"An error occurred during system operation: {e}")
